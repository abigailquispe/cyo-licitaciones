...
%  Compilar:  pdflatex consultas_observaciones_CPS_001-2026-DP.tex   (x2)
% ============================================================================
...
\vspace{6pt}
\noindent\footnotesize\textit{Nota: las citas entre comillas («\ldots») son textuales del Capítulo III — Requerimiento (TDR). La referencia de página corresponde a la paginación oficial de las Bases.}
\normalsize
...
5 & Capítulo III — Requisitos de Calificación & C.2.2 (Capacitación del personal clave) & 54 &
Como requisito de calificación se exige que los dos (02) especialistas cuenten con cursos \cita{de las marcas de la solución a implementar}. Solicitamos confirmar que se aceptará la capacitación correspondiente a \textbf{cualquier marca o fabricante} que el postor oferte e implemente, y no únicamente de una marca predeterminada, a fin de no restringir la participación. &
...
3 & Capítulo IV — Evaluación de Ofertas & Factor I (Mejoras a los TDR) y 4.1 & 59--61 &
